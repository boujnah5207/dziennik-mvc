...
namespace Dziennik_MVC.Areas.Admin.Controllers
{
    ...
    public class StudenciController : Controller
    {
        ...
        private IStudenciRepository _repo1;
        private IUzytkownicyRepository _repo2;
         private readonly ILogger _logger;

        public StudenciController(IGrupyRepository repo, IStudenciRepository repo1, IUzytkownicyRepository repo2, ILogger logger) 
        {
            _repo = repo;
            _repo1 = repo1;
            _repo2 = repo2;
        ...
        public ViewResult List(string sortOrder, int? page)
        {
            ...
            switch (sortOrder)
            {
                ...
                case "Index asc":
                    ...
                    break;
                default:
                    students = students.OrderBy(s => s.id_uzytkownika);
                    break;
            }
